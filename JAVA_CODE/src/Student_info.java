...
public class Student_info extends JFrame {
	...
	public Student_info() {
		...
		nameList = new ArrayList<String>(); nameList.add("Aditya");nameList.add("Raunak");nameList.add("Anupam"); nameList.add("Rohan");
		passList = new ArrayList<String>();  passList.add("AB"); passList.add("RKJ"); passList.add("AR"); passList.add("RT");
		idList = new ArrayList<String>(); idList.add("iit2020033"); idList.add("iit2020031");idList.add("iit2020034"); idList.add("iit2020088");
